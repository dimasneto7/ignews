...
[Ig.news](https://ignews-peach.vercel.app/) is a project created in [Rocketseat](https://rocketseat.com.br/) Ignite ReactJS training.
...
```bash
$ git clone https://github.com/dimasneto7/ignews && cd ignews
```
